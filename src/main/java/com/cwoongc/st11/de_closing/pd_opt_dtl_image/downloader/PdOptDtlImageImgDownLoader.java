        ...
        PlanItemProcessor planItemProcessor = new PlanItemProcessor(planItem, new PlanItemProcessorLogic() {
            ...
            public Object processPlanItem(String planItem) {
                ...
                try {
                    ...
                    Map<String, UrlFilepath> urlFilepathMap = getGson().fromJson(imgUrlsJson, new TypeToken<Map<String, UrlFilepath>>() {
                    }.getType());
                    ...
                    log.error("Image downloading error occurred : "+ "prd_no : [" + cols[0] + "], opt_item_no : [" + cols[2] + "], opt_value_no : [" + cols[3] + "], Json : " + imgUrlsJson + " : " + e.getMessage(), e);
                }
